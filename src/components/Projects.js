export default function Projects() {
    ...
    <div className="py-12 md:pl-16">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {projects.map((project, index) => (
          <div key={index} className="border border-gray-200 hover:border-gray-400 rounded-lg p-6 hover:shadow-lg transition-all duration-300 flex flex-col" style={{ backgroundColor: '#FFF9F2' }}>
            ...
            <div className="flex flex-wrap gap-2 mb-4 h-16 overflow-hidden">
              {project.technologies.map((tech) => (
                <span key={tech} className="px-3 py-1 bg-gray-100 text-gray-700 hover:bg-gray-900 hover:text-white rounded-md text-sm transition-colors duration-300 cursor-pointer h-fit">
                  {tech}
                </span>
              ))}
            </div>
            <a href={project.link} className="text-gray-900 hover:text-gray-700 font-medium mt-auto transition-colors duration-300">
              View Project →
            </a>
          </div>
        ))}
  ...
  //       {projects.map((project, index) => (
  //         <div key={index} className="border border-gray-200 hover:border-gray-400 rounded-lg p-6 hover:shadow-lg transition-all duration-300" style={{ backgroundColor: '#FFF9F2' }}>
  ...
  //               {project.technologies.map((tech) => (
  //                 <span key={tech} className="px-3 py-1 bg-gray-100 text-gray-700 hover:bg-gray-900 hover:text-white rounded-md text-sm transition-colors duration-300 cursor-pointer">
  //                   {tech}
  //                 </span>
  //               ))}
  //             </div>
  //           </div>
  //           <a href={project.link} className="inline-block mt-4 text-gray-900 hover:text-gray-700 font-medium transition-colors duration-300">
  //             View Project →
  //           </a>
  //         </div>
  //       ))}
